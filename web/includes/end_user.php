...
<body>
    ...
    <table lang="VI" align="center" width="1200px" border="1">
        ...
        <?php
            ...
            if(isset($_GET['page']) && (int) $_GET['page']){
                ...
                require("config.php");
                $numSql = "SELECT COUNT(id) FROM end_account";
            ...
            require("config.php");
            $sql = "select * from end_account order by username ASC LIMIT $start, $display";
            ...
            if(mysql_num_rows($query) == ""){
                ...
                while($row = mysql_fetch_array($query)){
                    ...
                    echo "<td>Member</td>";                      
                    echo "<td><a href='profile_end.php?userid=$row[id]'>Profile</a></td>";
                    echo "</tr>";
                }
            }
        ?>
    ...
    <ul class="page">
        ...
        if($page > 1){
            ...
            if($current != 1){
                echo "<li><a href='end_user.php?start=$prev&page=$page&index=".($j-1)."'>Previous</a></li>";
            }

            for($i=$minIndex; $i<=$maxIndex; $i++)
                if($current != $i){
                    echo "<li><a href='end_user.php?start=".$display*($i-1)."&page=$page&index=$i'>$i</a></li>";
                }else{
                    echo "<li class='current' >$i</li>";
                }

            if($current != $page){
                echo "<li><a href='end_user.php?start=$next&page=$page&index=".($j+1)."'>Next</a></li>";
            }
        }
        ?>
    </ul>
